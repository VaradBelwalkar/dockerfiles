...
docker build -t varadbelwalkar/docker -f docker/dockerfile ./docker
docker build -t varadbelwalkar/go -f go/dockerfile ./go
...
docker build -t varadbelwalkar/user_key_ssh_able_ubuntu -f user_key_ssh_able/ubuntu_dockerfile ./user_key_ssh_able
